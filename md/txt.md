...
-   **If 'Neon Serverless (HTTP)' is chosen:**
    ...
    npm install -D drizzle-kit javascript tsx
    ```
-   **If 'Neon WebSocket' is chosen:**
    ```bash
    npm install drizzle-orm @neondatabase/serverless dotenv ws
    npm install -D drizzle-kit javascript tsx @types/ws
    ```
-   **If '`node-postgres`' is chosen:**
    ```bash
    npm install drizzle-orm pg dotenv
    npm install -D drizzle-kit javascript tsx @types/pg
    ```
...
```javascript title="drizzle.config.ts"
...
```javascript title="src/schema.ts"
